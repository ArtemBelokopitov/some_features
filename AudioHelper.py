...
def command():
    r = sr.Recognizer()
    #прослушивание команд от пользователя
    ...
    #распознавание речи пользователя, поиск и обработка исключение, предоставление пользователю инфо о сказанном ранее
    try:
...
#доп. функции для исходных запросов
class SecretMessage():
...
#основная функция, сверяющая сказанное c известными командами
def mainFunction(PersonAudio):
...
#    elif "какие актуальные новости" in PersonAudio:
    ...
    #парсинг и передача информации со стороннего сайта
