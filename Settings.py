...
class Setting(QWidget):
        ...
        def __init__(self):
            ...
            self.setWindowIcon(QIcon(self.homepath+'/Desktop/проект/ProgrammFiles/setting.png'))
        ...
        def GreyFon(self):
            ...
            with open(self.homepath+"/Desktop/проект/ProgrammFiles/ButtonColor.txt", "w") as colorfile:
